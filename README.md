...
* __Add pet__  
        ...
        curl -X POST http://localhost:8080/v1/pets/add -H "Content-Type: application/json" -d '{"petAge":4, "petId":3, "petName": "Bella", "petType": "Horse"}' 
        

* __Update pet__ 
        
        curl -X PUT http://localhost:8080/v1/pets/update/3 -H "Content-Type: application/json" -d '{"petAge":4, "petId":3, "petName": "Coco", "petType": "Horse"}' 
...
* __Add pet-type__  
        ...
        curl -X POST http://localhost:8080/v1/pets-types/add -H "Content-Type: application/json" -d '{"petTypeName": "Bird"}'         
      

* __Update pet-type__ 
        
        curl -X PUT http://localhost:8080/v1/pets-types/update/4 -H "Content-Type: application/json" -d '{"petTypeName": "Fish"}' 
